...
CSV_PATH = "./metadata/salux_baseline.csv"
OUT_DIR = Path("./results/baseline_salux_6cls")
...
train_ds = Skeleton3DDataset(train_df)
label_to_idx = train_ds.label_to_idx
idx_to_label = {v: k for k, v in label_to_idx.items()}

val_ds = Skeleton3DDataset(val_df, label_to_idx=label_to_idx)
test_ds = Skeleton3DDataset(test_df, label_to_idx=label_to_idx)
...
best_val_acc = -1.0
best_path = OUT_DIR / "best_baseline_salux.pt"
...
save_confmat(cm, class_names, OUT_DIR / "confmat_salux_test.png", "Baseline 3D - Salux Test")
