...
OUT_DIR = Path("./results/mv3d_model_6cls")
...
def alignment_loss(z0, z1, z2, z3):
    ...
    l12 = 1.0 - F.cosine_similarity(z1, z2, dim=1).mean()
    l13 = 1.0 - F.cosine_similarity(z1, z3, dim=1).mean()
    l23 = 1.0 - F.cosine_similarity(z2, z3, dim=1).mean()

    return (l01 + l02 + l03 + l12 + l13 + l23) / 6.0
...
best_epoch = -1
epochs_no_improve = 0
best_path = OUT_DIR / "best_mv3d.pt"
...
for epoch in range(1, EPOCHS + 1):
    ...
    for cam0, cam1, cam2, cam3, y in train_loader:
        ...
        optimizer.zero_grad()
        logits, z0, z1, z2, z3 = model(cam0, cam1, cam2, cam3)

        loss_cls = criterion(logits, y)
        loss_align = alignment_loss(z0, z1, z2, z3)
...
save_confmat(cm, class_names, OUT_DIR / "confmat_salux_test.png", "MV3D - Salux Test")
